\documentclass[aspectratio=43,scheme=plain,handout,draft]{ctexbeamer}
%\usepackage{xeCJK}
...
\hypersetup{
	...
	pdfsubject={Galvano, Ion imaging},
...
\begin{frame}{\insertsection}
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			...
			\node at (-0.75,2){\textcolor[RGB]{0,112,127}{$\num{463.985}\unit{\nano \meter}$}};
...
%
%	\begin{frame}
	%	このスライドは\footfullcite{galvano}ソースコードが\qrcode[hyperlink,height=2cm]{https://github.com/xiaoyuleiba/MachinetimeReport}で公開される。
%	\end{frame}
\end{document}
