...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5]
		...
		\filldraw[white] (-1.92,2.5) rectangle (-1.88,2.89);
		\onslide<-3>{
		\node at (-1.5,3.2){\textcolor[RGB]{0,112,127}{{\tiny $\num{464.484}\unit{\nano \meter}$}}};
		\node at (-0.93,2.45){\textcolor[RGB]{0,112,127}{{\tiny $\num{464.114}\unit{\nano \meter}$}}};
		}
		\node at (0.8,1.85){\textcolor[RGB]{0,112,127}{{\tiny $\num{460.875}\unit{\nano \meter}$}}};
		\node at (2.3,-0.4){\textcolor[RGB]{0,112,127}{{\tiny $\num{456.659}\unit{\nano \meter}$}}};
		...
		\onslide<2>{
		\node[above] at (-0.5,-5){\textcolor{red}{\tiny +9 peak}};
		\node[below] at (-0.5,-5){\textcolor{red}{\tiny 45.5$\rightarrow$48.5}};
		}
		\onslide<3>{
