...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5]
		...
		\onslide<3->{
		\node[above] at (-0.5,-5){\textcolor{red}{\tiny \textquestiondown\textquestiondown\textquestiondown}};
	...
	\begin{table}
		...
		\begin{tabularx}{0.8\textwidth}{llll}    
			...
			$\approx43058.49 \unit{\per \centi \meter}$ &   $\approx43092.81\unit{\per \centi \meter}$ &  $\approx 43395.69\unit{\per \centi \meter}$ & $\approx 43796.34\unit{\per \centi \meter} $\\
			\midrule   
			$\text{px}=253.162$ & $\text{px}=253.655$ & $\text{px}=256.240$ &$ \text{px}=246.776$ \\  
			\midrule 
			$rR2\left( 44.5\right) $ & $rR2\left( 45.5\right) $ &  $sR21\left( 48.5\right) $ &$sR21\left( 58.5\right) $\\  
			\bottomrule    
		\end{tabularx}%  
	\end{table}
\end{figure}
