...
\end{tikzpicture}
			...
			\begin{column}{0.6\textwidth}
				...
				\onslide<3->{
					\begin{alertblock}{Notice}
					What we are calculating here are actually $\left| \mathbf{v}_{\ce{NO}}  \right| $, which are not supposed to be  \textcolor{red}{minus nor extremely huge}.
					\onslide<4>{\footnote{Maybe $\num{\pm 5}\unit{\meter \per \second}$-level noise are permitted.}}
				\end{alertblock}
			}
				\end{column}
		\end{columns}
