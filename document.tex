...
\begin{tikzpicture}
	...
	\node at (-4,-2){{\small $\frac{d v}{d\, \text{px}} = 12.04\unit{\meter \per \second}/\text{px}\,@\, ^3P_2 $}};
	\node at (0,-2){{\small $\frac{d v}{d\, \text{px}} = 12.14\unit{\meter \per \second}/\text{px}\,@\, ^3P_1$}};
	\node at (4,-2){{\small $\frac{d v}{d\, \text{px}} = 12.18\unit{\meter \per \second}/\text{px}\,@\, ^3P_0$}};
\end{tikzpicture}
		\end{figure}
	\end{frame}
%	
