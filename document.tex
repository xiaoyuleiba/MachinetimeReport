...
\begin{tikzpicture}
	...
	\node at (-3.7,-2){$\frac{d v}{d\, \text{px}} = 12.04\unit{\meter \per \second}/\text{px}$};
	\node at (0,-2){$\frac{d v}{d\, \text{px}} = 12.14\unit{\meter \per \second}/\text{px}$};
	\node at (3.7,-2){$\frac{d v}{d\, \text{px}} = 12.18\unit{\meter \per \second}/\text{px}$};
\end{tikzpicture}
		\end{figure}
	\end{frame}
%	
