...
\begin{tikzpicture}
	...
	\node[anchor=west] at (2.3,2){{\footnotesize $12.42\unit{\meter \per \second }\,\text{px}^{-1} $}};
	\node[anchor=west] at (2.3,1.5){Intercept $\approx\num{-1299}\unit{\meter \per \second}$};
	\node[anchor=west] at (2.3,0.8){$^3P_1 $};
	\node[anchor=west] at (2.3,0.3){{\footnotesize $ 12.54\unit{\meter \per \second}\,\text{px}^{-1}$}};
	\node[anchor=west] at (2.3,-0.2){Intercept $\approx\num{-1332}\unit{\meter \per \second}$};
	\node[anchor=west] at (2.3,-1.5){$^3P_0 $};
	\node[anchor=west] at (2.3,-2){{\footnotesize $ 12.54\unit{\meter \per \second}\,\text{px}^{-1}$}};
