...
\end{table}%
\end{frame}
	\subsubsection{$y$ tans. speed of \ce{NO}}
	\begin{frame}{\insertsubsection}{\insertsubsubsection}
\begin{table}[htbp]  
	\centering  
	\tiny   
...
\begin{tikzpicture}
	...
	\node[anchor=west] at (-5.5,-2.3){{\footnotesize $12.42\unit{\meter \per \second }\,\text{px}^{-1} $}};
	\node[anchor=west] at (-5.5,-2.8){Intercept $\approx\num{-1299}\unit{\meter \per \second}$};
	\node[anchor=west] at (-1.4,-1.8){$^3P_1 $};
	\node[anchor=west] at (-1.4,-2.3){{\footnotesize $ 12.54\unit{\meter \per \second}\,\text{px}^{-1}$}};
	\node[anchor=west] at (-1.4,-2.8){Intercept $\approx\num{-1332}\unit{\meter \per \second}$};
	\node[anchor=west] at (2.7,-1.8){$^3P_0 $};
	\node[anchor=west] at (2.7,-2.3){{\footnotesize $ 12.54\unit{\meter \per \second}\,\text{px}^{-1}$}};
...
\begin{frame}{\insertsubsection}{\insertsubsubsection}
	...
	\node[anchor=west] at (4,-0.5){{\footnotesize $ 12.49\unit{\meter \per \second}\,\text{px}^{-1}$}};
	\node[anchor=west] at (4,-1){Intercept $\approx\num{-1326}\unit{\meter \per \second}$};	
\end{tikzpicture}
		\end{figure}
	\end{frame}
%	
