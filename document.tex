...
\begin{tikzpicture}
	...
	\node[anchor=west] at (-5.5,-2.3){{\footnotesize $12.42\unit{\meter \per \second \per px}/\text{px} $}};
	...
	\node[anchor=west] at (4,-2){{\footnotesize $ 12.50\unit{\meter \per \second}/\text{px}\,@\, ^3P_0$}};
\end{tikzpicture}
\end{figure}
\end{frame}
\begin{frame}{\insertsubsection}{\insertsubsubsection}
