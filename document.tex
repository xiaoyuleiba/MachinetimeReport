...
\begin{tikzpicture}
	...
	\onslide<2->{
	\draw[trigon,thick] (-0.9,1.76) rectangle (-1.82,2.13);
	\draw[trigon,thick] (-1,0.13) rectangle (-1.82,0.5);
	\draw[trigon,thick] (-0.9,-1.5) rectangle (-1.82,-1.13);
	\draw[trigon,thick] (-0.9,-3.13) rectangle (-1.82,-2.76);}
\end{tikzpicture}
				\end{column}
