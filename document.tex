...
\end{tikzpicture}
			...
			\begin{column}{0.6\textwidth}
				\begin{tikzpicture}
					...
					\node[anchor=west] at (3,2.5){$^3P_1 $};
					\node[anchor=west] at (3,2){{\footnotesize $ 107\unit{\meter \per \second}\,\mathrm{px}^{-1}$}};
					\node[anchor=west] at (3,1.5){Intercept $\approx\textcolor{red}{\num{-1298}}\unit{\meter \per \second}$};
