...
\onslide<2>{
	\node at (1.88,2.4){qQ1(6.5)\quad6.5 $\rightarrow$ 6.5};
	\node at (2.08,2){\& qP21(6.5)\quad6.5 $\rightarrow$ 6.5};
	\node at (2.08,1.6){\!\!\!\& qR1(0.5)\quad1.5 $\rightarrow$ 0.5};
	\node at (2.08,1.2){\& qQ21(0.5)\quad6.5 $\rightarrow$ 0.5};
	\node at (2.08,0.8){\quad\;\,\& oP12(32.5)\quad31.5 $\rightarrow$ 32.5};
}
...
\onslide<2>{
	\node at (2,2.4){qQ2(19.5)\quad20.5 $\rightarrow$ 19.5};
