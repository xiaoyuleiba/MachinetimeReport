...
\onslide<2>{
	...
	\node at (2.2,2.2){\& qP21(6.5)\quad6.5 $\rightarrow$ 6.5};
	\node at (2.2,2){\& qR1(0.5)\quad1.5 $\rightarrow$ 0.5};
	\node at (2.2,1.8){\& qQ21(0.5)\quad6.5 $\rightarrow$ 0.5};
	\node at (2.2,1.6){\& oP12(32.5)\quad31.5 $\rightarrow$ 32.5};
}
