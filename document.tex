...
\onslide<2>{
	...
	\node[trigon] at (3.07,3.3){\textcolor{trigon}{Abel${}^{-1}$}};}
\end{tikzpicture}
\end{figure}
\end{frame}
\begin{frame}{Peak 2}
	...
	\onslide<1,2>{\node at (0,0){\includegraphics[width=0.6\textwidth]{scanmark.eps}};
	\filldraw[white] (-1.92,2.5) rectangle (-1.88,2.89);
			\node at (-0.93,2.03){\textcolor{trigon}{$\num{464.114}\unit{\nano \meter}$}};
}
\onslide<2>{	
	...
	\node at (2.03,1.6){\textcolor{red}{{\quad\!}qQ2(51.5)}};
		...
		\onslide<3>{\node at (-1.55,2){\includegraphics[width = 4cm]{gring_464114.eps}};
			...
			\node at (1.3,-3.2){\textcolor{trigon}{\small $\beta \approx 1.22$}};
				\node at (-3.0,3.3){\textcolor{trigon}{smear}};
			\node at (3.07,3.3){\textcolor{trigon}{Abel${}^{-1}$}};
			}
\end{tikzpicture}
\end{figure}
\end{frame}
...
\begin{tikzpicture}
			\onslide<1,2>{\node at (0,0){\includegraphics[width=0.6\textwidth]{scanmark.eps}};
			\filldraw[white] (-1.92,2.5) rectangle (-1.88,2.89);
			\node at (0.47,1.5){\textcolor{trigon}{$\num{460.875}\unit{\nano \meter}$}};
			}
			\onslide<2>{
			...
			\node at (1.3,-3.2){\textcolor{trigon}{\small$\beta \approx 0.864$}};
				\node at (-3.0,3.3){\textcolor{trigon}{smear}};
			\node at (3.07,3.3){\textcolor{trigon}{Abel${}^{-1}$}};}
\end{tikzpicture}
\end{figure}
...
\begin{tikzpicture}
		\onslide<1,2>{
			\node at (0,0){\includegraphics[width=0.6\textwidth]{scanmark.eps}};
			\filldraw[white] (-1.92,2.5) rectangle (-1.88,2.89);
			\node at (2.3,-0.25){\textcolor{trigon}{$\num{456.659}\unit{\nano \meter}$}};
}
\onslide<2>{
			...
			\node at (1.3,-1.2){\small\textcolor{trigon}{$\beta \approx 0.440$}};
				\node at (-3.0,3.3){\textcolor{trigon}{smear}};
			\node at (3.07,3.3){\textcolor{trigon}{Abel${}^{-1}$}};}
\end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5]
		...
		\node[above] at (4.5,-5){{\tiny +10 peak}};
		\node[below] at (4.5,-5){{\tiny 48.5$\rightarrow$58.5}};
		\node[anchor=west,trigon] at (2,1){{\tiny Only 2 valid peaks.}};
		}
	\end{tikzpicture}
	\begin{table}
		\centering  	 
