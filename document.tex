...
\end{tikzpicture}
			...
			\begin{column}{0.6\textwidth}
				\onslide<2>{\begin{alertblock}{Notice}
					Areas where are \textcolor{trigon}{framed} make those results physically meaningless, as \textcolor{red}{intercepts} are not supposed to be minus and such a huge numberin page \pageref{intercept1} and \pageref{intercept2}.
				\end{alertblock}}
				\end{column}
		\end{columns}
\end{frame}
