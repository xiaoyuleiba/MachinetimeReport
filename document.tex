...
\onslide<2>{	
	...
	\node at (2.03,1.6){\textcolor{red}{{\quad\!}qQ2(51.5)}};
		...
		\onslide<3>{\node at (-1.55,2){\includegraphics[width = 4cm]{gring_464114.eps}};
			...
			\node[trigon] at (1.3,-3.2){{\small $\beta \approx 1.22$}};
			\node[trigon] at (-3.0,3.3){smear};
			\node[trigon] at (3.07,3.3){Abel${}^{-1}$};
			}
\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5]
		...
		\onslide<3>{
		\node[above] at (-0.5,-5){\textcolor{red}{\tiny ???}};
		\node[below] at (-0.5,-5){\textcolor{red}{\tiny \textquestiondown\textquestiondown\textquestiondown}};
		}
		\onslide<4>{
		\draw[|->|,trigon] (2,-5)--(7,-5);	
		\node[above] at (4.5,-5){{\tiny +10 peak}};
