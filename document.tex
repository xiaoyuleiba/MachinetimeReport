...
\begin{table}[htbp]
	...
	\begin{tabular}{l|cc}
		...
		\midrule
		\multirow{2}[1]{*}{$^3 P_2$} & $2972.480768\unit{\meter \per \second}$ & 129 px \\
		& $2956.781013\unit{\meter \per \second}$ & 129 px \\
		\multirow{2}[1]{*}{($\num{0}\unit{\per \centi \meter}$)} & $2933.706617\unit{\meter \per \second}$ & 129 px \\
		& $2737.524491 \unit{\meter \per \second}$ & 124.5 px \\
		\midrule
		\multirow{2}[1]{*}{$^3 P_1$} & $2951.129171\unit{\meter \per \second}$ & 129 px \\
		& $2935.315217\unit{\meter \per \second}$ & 129 px \\
		\multirow{2}[1]{*}{($\num{158.625}\unit{\per \centi \meter}$)} & $2912.070737 \unit{\meter \per \second}$ & 129 px \\
		& $2714.325294\unit{\meter \per \second}$ & 124.5 px \\
		\midrule
		\multirow{2}[1]{*}{$^3 P_0$} & $2941.880928\unit{\meter \per \second}$ & 129 px \\
		& $2926.016991\unit{\meter \per \second}$ & 129 px \\
		\multirow{2}[1]{*}{($\num{226.977}\unit{\per \centi \meter}$)} & $2902.698053 \unit{\meter \per \second}$ & 129 px \\
		& $2704.267334\unit{\meter \per \second}$ & 124.5 px \\
		\bottomrule
	\end{tabular}%
\end{table}%
\end{frame}
