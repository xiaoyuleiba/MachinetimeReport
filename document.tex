...
\begin{tikzpicture}
	...
	\node at (-4,-2){{\footnotesize $\frac{d v}{d\, \text{px}} = 12.76\unit{\meter \per \second}/\text{px}\,@\, ^3P_2 $}};
	\node at (0,-2){{\footnotesize $\frac{d v}{d\, \text{px}} = 12.67\unit{\meter \per \second}/\text{px}\,@\, ^3P_1$}};
