...
\begin{tikzpicture}
	...
	\onslide<2->{
	\draw[trigon,thick] (-0.9,1.76) rectangle (-1.78,2.13);
	\draw[trigon,thick] (-1,0.13) rectangle (-1.78,0.5);
	\draw[trigon,thick] (-0.9,-1.5) rectangle (-1.78,-1.13);
	\draw[trigon,thick] (-0.9,-3.13) rectangle (-1.78,-2.76);}
\end{tikzpicture}
				\end{column}
