...
\end{tikzpicture}
			...
			\begin{column}{0.6\textwidth}
				...
				\onslide<3>{
					\begin{alertblock}{Notice}
					Areas where are \textcolor{trigon}{framed} make those results physically invalid, as \textcolor{red}{intercepts} are not supposed to be minus and such huge numbers.
				\end{alertblock}
			}
				\end{column}
		\end{columns}
