...
\begin{frame}{\insertsubsection}\nocite{pgopher}
			...
			\begin{tabularx}{0.97\textwidth}{llll}    
				...
				\midrule   
				$\text{px}=253.177$ & $\text{px}=253.650$ & $\text{px}=\textcolor{red}{181.319}\,\&\,256.147$ &$ \text{px}=246.776$ \\  
				\midrule 
...
\begin{tikzpicture}
	...
	\footnotesize 
	\node[anchor=west] at (-5.5,-1.8){$^3P_2 $};
	\node[anchor=west] at (-5.5,-2.3){{\footnotesize $12.42\unit{\meter \per \second }/\text{px} $}};
	\node[anchor=west] at (-5.5,-2.8){Intercept $\approx\num{-1299}\unit{\meter \per \second}$};
	\node[anchor=west] at (-1.4,-1.8){$^3P_1 $};
	\node[anchor=west] at (-1.4,-2.3){{\footnotesize $ 12.54\unit{\meter \per \second}/\text{px}$}};
	\node[anchor=west] at (-1.4,-2.8){Intercept $\approx\num{-1332}\unit{\meter \per \second}$};
	\node[anchor=west] at (2.7,-1.8){$^3P_0 $};
	\node[anchor=west] at (2.7,-2.3){{\footnotesize $ 12.54\unit{\meter \per \second}/\text{px}$}};
	\node[anchor=west] at (2.7,-2.8){Intercept $\approx\num{-1347}\unit{\meter \per \second}$};	
\end{tikzpicture}
\end{figure}
\end{frame}
\begin{frame}{\insertsubsection}{\insertsubsubsection}
	...
	\node[anchor=west] at (2.7,0){Average};
	\node[anchor=west] at (2.7,-0.5){{\footnotesize $ 12.54\unit{\meter \per \second}/\text{px}$}};
	\node[anchor=west] at (2.7,-1){Intercept $\approx\num{-1347}\unit{\meter \per \second}$};	
\end{tikzpicture}
		\end{figure}
	\end{frame}
%	
