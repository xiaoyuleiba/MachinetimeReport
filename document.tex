...
\begin{tikzpicture}
	...
	\onslide<2->{
	\draw[trigon,thick] (-1,1.76) rectangle (-1.62,2.13);
	\draw[trigon,thick] (-1,0.13) rectangle (-1.62,0.5);
	\draw[trigon,thick] (-1,-1.5) rectangle (-1.62,-1.13);
	\draw[trigon,thick] (-1,-3.13) rectangle (-1.62,-2.76);}
\end{tikzpicture}
				\end{column}
