...
\end{frame}
	...
	\begin{table}[htbp]  
		...
		\tiny   
		\begin{tabular}{l|cc}    
			\multicolumn{1}{l}{\multirow{2}[1]{*}{$E_\text{int.}(\ce{O})$}} & \multicolumn{1}{l}{$v(\ce{NO}) $} & \multirow{2}[1]{*}{$\Delta y $} \\    \multicolumn{1}{l}{} & \multicolumn{1}{l}{$= \sqrt {  \frac{2E_\text{trans}(\ce{NO})}{m(\ce{}NO)}   }$} &  \\    \midrule    \multirow{2}[1]{*}{$^3 P_2$} & $2972.480768\unit{\meter } & 258 px \\          
			& 2956.781013 & 258 px \\    
