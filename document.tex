...
\begin{tikzpicture}
	...
	\node[anchor=west] at (-4,-1.8){$^3P_2 $};
	\node[anchor=west] at (-4.1,-2.3){{\footnotesize $12.42\unit{\meter \per \second}/\text{px} $}};
	\node[anchor=west] at (-4.1,-2.8){Intercept $\approx-1299$};
