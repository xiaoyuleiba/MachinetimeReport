...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\draw[white] (4.03,-3.65) rectangle (4,3.65);
		\node at (0,0){\includegraphics[width=0.3\textheight]{scanmark.eps}};
		\filldraw[white] (-1.92,2.5) rectangle (-1.88,2.89);
		\node at (-1.5,2.7){\textcolor[RGB]{0,112,127}{{\tiny $\num{464.484}\unit{\nano \meter}$}}};
		\node at (-0.93,2.03){\textcolor[RGB]{0,112,127}{{\tiny $\num{464.114}\unit{\nano \meter}$}}};
		\node at (0.47,1.5){\textcolor[RGB]{0,112,127}{{\tiny $\num{460.875}\unit{\nano \meter}$}}};
		\node at (2.3,-0.25){\textcolor[RGB]{0,112,127}{{\tiny $\num{456.659}\unit{\nano \meter}$}}};
	\end{tikzpicture}
\end{figure}
	\begin{table}
		\centering  	 
