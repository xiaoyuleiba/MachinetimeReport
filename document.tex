...
\end{frame}
	\begin{frame}{\insertsubsection}{\insertsubsubsection}
		\begin{figure}[H]
			\centering
\begin{tikzpicture}
	\node at (0,-1){\includegraphics[height=7cm]{3p012.eps}};
	{\footnotesize 
	...
	\node[anchor=west] at (2,-3.5){$^3P_0 $};
	\node[anchor=west] at (2,-4){{\footnotesize $ 12.54\unit{\meter \per \second}\,\text{px}^{-1}$}};
	\node[anchor=west] at (2,-4.5){Intercept $\approx\num{-1347}\unit{\meter \per \second}$};	}
\end{tikzpicture}
\end{figure}
\end{frame}
\begin{frame}{\insertsubsection}{\insertsubsubsection}
