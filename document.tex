...
\begin{frame}{\insertsubsection}
			...
			\begin{tabularx}{0.9\textwidth}{llll}   
				...
				\textcolor[RGB]{0,112,127}{qR12 51.5} & \textcolor[RGB]{0,112,127}{qR12 51.5} & \textcolor[RGB]{0,112,127}{} & \textcolor[RGB]{0,112,127}{pQ12 76.5} \\ 
				\textcolor[RGB]{0,112,127}{qQ2 51.5} & \textcolor[RGB]{0,112,127}{qQ2 51.5} & \textcolor[RGB]{0,112,127}{} & \textcolor[RGB]{0,112,127}{pP2 76.5} \\ 
				\bottomrule    
			\end{tabularx}%  
			\label{tab:addlabel}%
		\end{table}%
	...
	\begin{frame}
		...
		\begin{table}[htbp]  \centering  \caption{Add caption}    \begin{tabularx}{0.6\textwidth}{ll}    \toprule          & $E_\text{total}$ \\    \midrule    Peak 1 & \multirow{2}[2]{*}{$\num{43058.49}\unit{\per \centi \meter}$} \\    $\num{464.484}\unit{\nano\meter} &  \\\cmidrule{2-2}    Peak 2 & \multirow{2}[2]{*}{$\num{43092.81}\unit{\per \centi \meter}$} \\    $\num{464.114}\unit{\nano\meter} &  \\\cmidrule{2-2}    Peak 3 & \multirow{2}[2]{*}{$\num{43395.69}\unit{\per \centi \meter}$} \\    $\num{460.875}\unit{\nano\meter} &  \\\cmidrule{2-2}    Peak 4 & \multirow{2}[1]{*}{$\num{43796.34}\unit{\per \centi \meter}$} \\    $\num{456.659}\unit{\nano\meter} &  \\    \end{tabularx}%  
			\label{tl}%
		\end{table}%
	\end{frame}
