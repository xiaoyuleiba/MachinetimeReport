...
\onslide<2>{
	\node at (1.83,2.4){qQ1(6.5)\quad6.5 $\rightarrow$ 6.5};
	\node at (2.03,2){\& qP21(6.5)\quad6.5 $\rightarrow$ 6.5};
	\node at (2.03,1.6){\!\!\!\& qR1(0.5)\quad1.5 $\rightarrow$ 0.5};
	\node at (2.03,1.2){\& qQ21(0.5)\quad6.5 $\rightarrow$ 0.5};
	\node at (2.03,0.8){\quad\;\,\& oP12(32.5)\quad31.5 $\rightarrow$ 32.5};
	\node at (1.63,0.4){offset = $\num{-1.2}\unit{\per \centi \meter}$};
}
...
\onslide<2>{
	...
	\node at (1.63,1.6){offset = $\num{0}\unit{\per \centi \meter}$};
}
