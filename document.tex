...
\begin{table}[htbp]  
	...
	\end{table}%
\end{frame}
	\begin{frame}{\insertsubsection}{\insertsubsubsection}\label{intercept1}
		\begin{figure}[H]
			\centering
\begin{tikzpicture}
	\node at (0,0){\includegraphics[height=6.8cm]{3p012.eps}};
	\node[anchor=west] at (2.3,2.5){$^3P_2 $};
	\node[anchor=west] at (2.3,2){{\footnotesize $12.28\unit{\meter \per \second }\,\mathrm{px}^{-1} $}};
	\node[anchor=west] at (2.3,1.5){Intercept $\approx\textcolor{red}{\num{-1265}}\unit{\meter \per \second}$};
	\node[anchor=west] at (2.3,0.5){$^3P_1 $};
	\node[anchor=west] at (2.3,0){{\footnotesize $ 12.37\unit{\meter \per \second}\,\mathrm{px}^{-1}$}};
	\node[anchor=west] at (2.3,-0.5){Intercept $\approx\textcolor{red}{\num{-1298}}\unit{\meter \per \second}$};
	\node[anchor=west] at (2.3,-1.5){$^3P_0 $};
	\node[anchor=west] at (2.3,-2){{\footnotesize $ 12.40\unit{\meter \per \second}\,\mathrm{px}^{-1}$}};
	\node[anchor=west] at (2.3,-2.5){Intercept $\approx\textcolor{red}{\num{-1313}}\unit{\meter \per \second}$};
\end{tikzpicture}
\end{figure}
\end{frame}
\begin{frame}{\insertsubsection}{\insertsubsubsection}\label{intercept2}
	\begin{figure}[H]
		\centering
\begin{tikzpicture}
		\node at (0,0){\includegraphics[width = 0.6\textwidth]{averagespeed.eps}};
	\node[anchor=west] at (4,0){Average};
	\node[anchor=west] at (4,-0.5){{\footnotesize $ 12.35\unit{\meter \per \second}\,\mathrm{px}^{-1}$}};
...
\begin{tikzpicture}
	\node at (0,0){\includegraphics[height=7cm]{vdis.eps}};
	\draw[trigon,thick] (-0.9,1.76) rectangle (-1.62,2.13);
	\draw[trigon,thick] (-0.9,0.13) rectangle (-1.62,0.5);
	\draw[trigon,thick] (-0.9,-1.5) rectangle (-1.62,-1.13);
	\draw[trigon,thick] (-0.9,-3.13) rectangle (-1.62,-2.76);
\end{tikzpicture}
				\end{column}
			\begin{column}{0.6\textwidth}
				\begin{tikzpicture}
					{\footnotesize 
					\node[anchor=west] at (0,2.5){$^3P_2 $};
					\node[anchor=west] at (0,2){{\footnotesize $12.28\unit{\meter \per \second }\,\mathrm{px}^{-1} $}};
					\node[anchor=west] at (0,1.5){Intercept $\approx\textcolor{red}{\num{-1265}}\unit{\meter \per \second}$};
					\node[anchor=west] at (3.7,2.5){$^3P_1 $};
					\node[anchor=west] at (3.7,2){{\footnotesize $ 107\unit{\meter \per \second}\,\mathrm{px}^{-1}$}};
					\node[anchor=west] at (3.7,1.5){Intercept $\approx\textcolor{red}{\num{-1298}}\unit{\meter \per \second}$};
					\node[anchor=west] at (0,0.7){$^3P_0 $};
					\node[anchor=west] at (0,0.2){{\footnotesize $ 12.40\unit{\meter \per \second}\,\mathrm{px}^{-1}$}};
					\node[anchor=west] at (0,-0.3){Intercept $\approx\textcolor{red}{\num{-1313}}\unit{\meter \per \second}$};
					\node[anchor=west] at (3.7,0.7){Average};
					\node[anchor=west] at (3.7,0.2){{\footnotesize $ 12.35\unit{\meter \per \second}\,\mathrm{px}^{-1}$}};
					\node[anchor=west] at (3.7,-0.3){Intercept $\approx\textcolor{red}{\num{-1292}}\unit{\meter \per \second}$};}	
				\end{tikzpicture}
				\onslide<2>{\begin{alertblock}{Notice}
					Areas where are \textcolor{trigon}{framed} make those results physically meaningless, as \textcolor{red}{intercepts} are not supposed to be minus and such huge numbers as what are shown among page \pageref{intercept1} and \pageref{intercept2}.
				\end{alertblock}}
				\end{column}
		\end{columns}
\end{frame}
