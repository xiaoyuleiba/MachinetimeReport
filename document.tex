...
Click \textcolor{blue}{\href{https://github.com/xiaoyuleiba/MachinetimeReport}{HERE}} or scan \qrcode[height=2 cm,]{URL}to check the latest version of this document.
	\end{frame}
	\begin{frame}{Contents}
	\tableofcontents
	\end{frame}
