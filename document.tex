...
\begin{table}[htbp]
	...
	\begin{tabularx}{0.9\textwidth}{l|cc}
		\multicolumn{1}{l}{\multirow{2}[1]{*}{$E_\text{int.}(\ce{O})$}\cite{3p012}} & \multicolumn{1}{l}{$E_\text{trans} (total)\approx2.88 E_\text{trans}(\ce{NO}) $} & \multicolumn{1}{l}{$E_\text{trans}(\ce{NO})$} \\
