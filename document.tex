...
\centering
	\begin{tikzpicture}
		...
		\draw (0,0)--(4.7,4.7)--(4.5,4.7)--(4.35,4.8);
...
%		\node[anchor=west] at (2,1){\textcolor{red}{The invented $(0,0)$ obtains a huge weight.}};
	\end{tikzpicture}
\end{figure}
\end{column}
\vrule
\begin{column}
	\textcolor{red}{The invented $(0,0)$ obtains a huge weight.}
\end{column}
	\end{columns}
\end{frame}	
%	\begin{columns}
