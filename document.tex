	...
	\begin{frame}{\insertsubsection}
		\begin{table}[htbp]
			...
			\begin{tabularx}{0.9\textwidth}{lccc}
				...
				\toprule
				Peak 1 & \multirow{2}[2]{*}{$\num{43058.49}\unit{\per \centi \meter}$} & \multirow{8}[8]{*}{$\num{25128.57}\unit{\per \centi \meter}$} & \multirow{2}[2]{*}{\qquad\quad\,\;\;$E_v (1\rightarrow 0)+ E( J = 44 )$\qquad\quad\,\;\;} \\
				$\num{464.484}\unit{\nano\meter}$ & & & \\
				\cmidrule{1-2}\cmidrule{4-4}
				Peak 2 & \multirow{2}[2]{*}{$\num{43092.81}\unit{\per \centi \meter}$} & & \multirow{2}[2]{*}{\qquad\quad\,\;\;$E_v (1\rightarrow 0)+ E( J = 45 )$\qquad\quad\,\;\;} \\
				$\num{464.114}\unit{\nano\meter}$ & & & \\
				\cmidrule{1-2}\cmidrule{4-4}
				Peak 3 & \multirow{2}[2]{*}{$\num{43395.69}\unit{\per \centi \meter}$} & & \multirow{2}[2]{*}{\qquad\quad\,\;\;$E_v (1\rightarrow 0)+ E( J = 48 )$\qquad\quad\,\;\;} \\
				$\num{460.875}\unit{\nano\meter}$ & & & \\
				\cmidrule{1-2}\cmidrule{4-4}
				Peak 4 & \multirow{2}[2]{*}{$\num{43796.34}\unit{\per \centi \meter}$} & & \multirow{2}[2]{*}{\qquad\quad\,\;\;$E_v (1\rightarrow 0)+ E( J = 58 )$\qquad\quad\,\;\;} \\
				$\num{456.659}\unit{\nano\meter}$ & & & \\
				\bottomrule
			\end{tabularx}
		\end{table}
