	...
	\begin{frame}
		\begin{table}[htbp]
			...
			\begin{tabularx}{0.9\textwidth}{lccc}
				...
				Peak 2 & \multirow{2}[2]{*}{$\num{43092.81}\unit{\per \centi \meter}$} & & \qquad\multirow{2}[2]{*}{$E (v = 1)+ E( J = 44 )$}\qquad \\
				$\num{464.114}\unit{\nano\meter}$ & & & \\
				\cmidrule{1-2}\cmidrule{4-4}
				Peak 3 & \multirow{2}[2]{*}{$\num{43395.69}\unit{\per \centi \meter}$} & & \qquad\multirow{2}[2]{*}{$E (v = 1)+ E( J = 44 )$}\qquad \\
				$\num{460.875}\unit{\nano\meter}$ & & & \\
				\cmidrule{1-2}\cmidrule{4-4}
				Peak 4 & \multirow{2}[2]{*}{$\num{43796.34}\unit{\per \centi \meter}$} & & \qquad\multirow{2}[2]{*}{$E (v = 1)+ E( J = 44 )$}\qquad \\
				$\num{456.659}\unit{\nano\meter}$ & & & \\
				\bottomrule
			\end{tabularx}
		\end{table}
