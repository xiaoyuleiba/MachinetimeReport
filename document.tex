...
\begin{table}[htbp]  \centering  \caption{Add caption}   \tiny \begin{tabularx}{0.9\textwidth}{l|cc}    \multicolumn{1}{l}{\multirow{2}[1]{*}{$E_\text{int.}(\ce{O})$}} & \multicolumn{1}{l}{$E_\text{trans} (total)\approx1.44E_\text{trans}(\ce{NO}) $} & \multicolumn{1}{l}{$E_\text{trans}(\ce{NO})$} \\    \multicolumn{1}{l}{} & \multicolumn{1}{l}{$= E_\text{total} -E_\text{bond}(\ce{O-NO})-E_\text{int.}(\ce{O})- E_\text{int.}(\ce{O}) $} & \multicolumn{1}{l}{ $= \frac{1}{2}m(\ce{NO})v^2(\ce{NO})$} \\    \midrule    \multirow{2}[1]{*}{$^3 P_2$} & $11081.356237\unit{\per \centi\meter}$ & $3847.69313784722\unit{\per \centi\meter}$ \\          & $10964.608538\unit{\per \centi\meter}$ & $3807.15574236111\unit{\per \centi\meter}$ \\    \multirow{2}[1]{*}{($\num{0}\unit{\per \centi \meter}$)} & $10794.143077\unit{\per \centi\meter}$ & $3747.96634618056\unit{\per \centi\meter}$ \\          & $9398.765977\unit{\per \centi\meter}$ & $3263.46040868055\unit{\per \centi\meter}$ \\    \midrule    \multirow{2}[1]{*}{$^3 P_1$} & $10922.731237\unit{\per \centi\meter}$ & $3792.61501284722\unit{\per \centi\meter}$ \\          & $10805.983538\unit{\per \centi\meter}$ & $3752.07761736111\unit{\per \centi\meter}$ \\    \multirow{2}[1]{*}{($\num{158.625}\unit{\per \centi \meter}$)} & $10635.518077\unit{\per \centi\meter}$ & $3692.88822118056\unit{\per \centi\meter}$ \\          & $9240.140977\unit{\per \centi\meter}$ & $3208.38228368055\unit{\per \centi\meter}$ \\    \midrule    \multirow{2}[1]{*}{$^3 P_0$} & $10854.379237\unit{\per \centi\meter}$ & $3768.88167951389\unit{\per \centi\meter}$ \\          & $10737.631538\unit{\per \centi\meter}$ & $3728.34428402778\unit{\per \centi\meter}$ \\    \multirow{2}[1]{*}{($\num{226.977}\unit{\per \centi \meter}$)} & $10567.166077\unit{\per \centi\meter}$ & $3669.15488784722\unit{\per \centi\meter}$ \\          & $9171.788977\unit{\per \centi\meter}$ & $3184.64895034722\unit{\per \centi\meter}$ \\    \bottomrule    \end{tabularx}%  
\end{table}%
\end{frame}
