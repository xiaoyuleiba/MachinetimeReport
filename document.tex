...
\begin{table}[htbp]  
	...
	\caption{Add caption} 
	\tiny   
	\begin{tabularx}{0.9\textwidth}{l|cr}    
		\multicolumn{1}{r}{} & \multicolumn{2}{l}{$E_\text{trans} (total)\approx1.44E_\text{trans}(\ce{NO}) $} \\    
		\multicolumn{1}{c|}{$E_\text{int.}(\ce{O})$} & \multicolumn{1}{l}{$= E_\text{total} -E_\text{bond}(\ce{O-NO})-E_\text{int.}(\ce{O})- E_\text{int.}(\ce{NO}) $} &  \\    \toprule    \multirow{2}[1]{*}{$^3 P_2$} & $11081.35624\unit{\per \centi\meter}$ &  \\          & $10964.60854\unit{\per \centi\meter}$ &  \\    \multirow{2}[1]{*}{($\num{0}\unit{\per \centi \meter}$)} & $10794.14308\unit{\per \centi\meter}$ &  \\          & $9398.765977 \unit{\per \centi\meter}$&  \\    \midrule    \multirow{2}[1]{*}{$^3 P_1$} &$ 10922.73124 \unit{\per \centi\meter}$&  \\          & $10805.98354\unit{\per \centi\meter}$ &  \\    \multirow{2}[1]{*}{($\num{158.625}\unit{\per \centi \meter}$)} & $10635.51808 \unit{\per \centi\meter}$&  \\          & $9240.140977 \unit{\per \centi\meter}$&  \\    \midrule    \multirow{2}[1]{*}{$^3 P_0$} & $10854.37924\unit{\per \centi\meter}$ &  \\          & $10737.63154\unit{\per \centi\meter}$ &  \\    \multirow{2}[1]{*}{($\num{226.977}\unit{\per \centi \meter}$)} &$ 10567.16608\unit{\per \centi\meter}$ &  \\          & $9171.788977\unit{\per \centi\meter}$ &  \\    \bottomrule    \end{tabularx}%  
\end{table}%
\end{frame}
\begin{frame}
	% Table generated by Excel2LaTeX from sheet 'Sheet1'
	\begin{table}[htbp]  \centering  \caption{Add caption}   \tiny \begin{tabularx}{0.9\textwidth}{l|cr}    \multicolumn{1}{l}{\multirow{2}[1]{*}{$E_\text{int.}(\ce{O})$}} & \multicolumn{1}{l}{$E_\text{trans} (total)\approx1.44E_\text{trans}(\ce{NO}) $} & \multicolumn{1}{l}{$E_\text{trans}(\ce{NO})$} \\    \multicolumn{1}{l}{} & \multicolumn{1}{l}{$= E_\text{total} -E_\text{bond}(\ce{O-NO})-E_\text{int.}(\ce{O})- E_\text{int.}(\ce{O}) $} & \multicolumn{1}{l}{ $= \frac{1}{2}m(\ce{NO})v^2(\ce{NO})$} \\    \midrule    \multirow{2}[1]{*}{$^3 P_2$} & 11081.35624 & 3847.693138 \\          & 10964.60854 & 3807.155742 \\    \multirow{2}[1]{*}{($\num{0}\unit{\per \centi \meter}$)} & 10794.14308 & 3747.966346 \\          & 9398.765977 & 3263.460409 \\    \midrule    \multirow{2}[1]{*}{$^3 P_1$} & 10922.73124 & 3792.615013 \\          & 10805.98354 & 3752.077617 \\    \multirow{2}[1]{*}{($\num{158.625}\unit{\per \centi \meter}$)} & 10635.51808 & 3692.888221 \\          & 9240.140977 & 3208.382284 \\    \midrule    \multirow{2}[1]{*}{$^3 P_0$} & 10854.37924 & 3768.88168 \\          & 10737.63154 & 3728.344284 \\    \multirow{2}[1]{*}{($\num{226.977}\unit{\per \centi \meter}$)} & 10567.16608 & 3669.154888 \\          & 9171.788977 & 3184.64895 \\    \bottomrule    \end{tabularx}%  
	\end{table}%
\end{frame}
%	
%	
