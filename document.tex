...
%		    $=43058.49 \unit{\per \centi \meter}$ &   $=43092.81\unit{\per \centi \meter}$ &  $= 43395.69\unit{\per \centi \meter}$ & $= 43796.34\unit{\per \centi \meter} $\\
%		   \midrule    
...
%	\end{table}%
%	
	 Table generated by Excel2LaTeX from sheet 'Sheet1'\begin{table}[htbp]  \centering  \caption{Add caption}    \begin{tabular}{llll}    \toprule    464.484 nm = 43058.49 /cm & 464.114 nm = 43092.81/cm & 460.875 nm = 43395.69/cm & 456.659 nm = 43796.34/cm \\    \midrule    px$=258$ & px$=258$ & px$=258$ & px$=249$ \\    rR2 44.5 & rR2 45.5 & sR21 48.5 & sR21 58.5 \\    \textcolor[rgb]{ 1,  0,  0}{qR12 51.5} & \textcolor[rgb]{ 1,  0,  0}{qR12 51.5} & \textcolor[rgb]{ 1,  0,  0}{} & \textcolor[rgb]{ 1,  0,  0}{pQ12 76.5} \\    \textcolor[rgb]{ 1,  0,  0}{qQ2 51.5} & \textcolor[rgb]{ 1,  0,  0}{qQ2 51.5} & \textcolor[rgb]{ 1,  0,  0}{} & \textcolor[rgb]{ 1,  0,  0}{pP2 76.5} \\    \bottomrule    \end{tabular}%  \label{tab:addlabel}%\end{table}%
\end{frame}
