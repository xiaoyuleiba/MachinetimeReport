...
\end{tikzpicture}
			...
			\begin{column}{0.6\textwidth}
				\begin{tikzpicture}
					...
					\node[anchor=west] at (0,-0.5){Intercept $\approx\textcolor{red}{\num{-1313}}\unit{\meter \per \second}$};
					\node[anchor=west] at (3.7,0.5){Average};
					\node[anchor=west] at (3.7,0){{\footnotesize $ 12.35\unit{\meter \per \second}\,\mathrm{px}^{-1}$}};
					\node[anchor=west] at (3.7,-0.5){Intercept $\approx\textcolor{red}{\num{-1292}}\unit{\meter \per \second}$};}	
				\end{tikzpicture}
