...
\begin{frame}{\insertsubsection}
			...
			\begin{tabularx}{0.9\textwidth}{llll}   
				...
				\textcolor[RGB]{0,112,127}{qQ2 51.5} & \textcolor[rgb]{ 1,  0,  0}{qQ2 51.5} & \textcolor[rgb]{ 1,  0,  0}{} & \textcolor[rgb]{ 1,  0,  0}{pP2 76.5} \\ 
				\bottomrule    
			\end{tabularx}%  
			\label{tab:addlabel}%
		\end{table}%
		\begin{block}{Notice}
			\textcolor[rgb]{1,0,0}{Red} assignments are mismatched, and will not be used to calculate.
		\end{block}
	\end{frame}
