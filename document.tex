...
\begin{frame}{\insertsubsection}
	...
	\begin{frame}{\insertsubsection}{\insertsubsubsection}
		\begin{table}[htbp]
			...
			\begin{tabularx}{0.9\textwidth}{lccc}
				\toprule
				                  \ruby[j]{{\CID{7652}}飾区}{かつ|し{\color{red}{か}}|く}                 &                       $E_\text{total}$                        &         $E_\text{bond}(\ce{O-NO})$\footfullcite{ono}          &                            $E_\text{int.}(\ce{NO})$                            \\ \midrule
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5]
		...
		\node[anchor=west,cyan] at (2,0.1){{\footnotesize if the amount of data $\leqslant3$.}};
		}
	\end{tikzpicture}
	\begin{table}
		\centering  	 
