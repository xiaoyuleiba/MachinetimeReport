...
\begin{tikzpicture}
	...
	{\footnotesize 
	\node[anchor=west] at (2,-1.8){$^3P_2 $};
	\node[anchor=west] at (2,-2.3){{\footnotesize $12.42\unit{\meter \per \second }\,\text{px}^{-1} $}};
	\node[anchor=west] at (2,-2.8){Intercept $\approx\num{-1299}\unit{\meter \per \second}$};
	\node[anchor=west] at (2,0){$^3P_1 $};
	\node[anchor=west] at (2,-0.5){{\footnotesize $ 12.54\unit{\meter \per \second}\,\text{px}^{-1}$}};
	\node[anchor=west] at (2,-1){Intercept $\approx\num{-1332}\unit{\meter \per \second}$};
