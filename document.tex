...
\begin{tikzpicture}
			...
			\node at (-1.5,2.7){\textcolor{trigon}{$\num{464.484}\unit{\nano \meter}$}};
...
\onslide<2>{
	...
	\node at (1.3,-3.2){\textcolor{trigon}{\small $\beta \approx 1.52$}};
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5]
		...
		\filldraw[white] (-1.92,2.5) rectangle (-1.88,2.89);
		\onslide<-3>{
		\node at (-1.5,3.2){\textcolor{trigon}{{\tiny $\num{464.484}\unit{\nano \meter}$}}};
		\node at (-0.93,2.45){\textcolor{trigon}{{\tiny $\num{464.114}\unit{\nano \meter}$}}};
		}
		\node at (0.8,1.85){\textcolor{trigon}{{\tiny $\num{460.875}\unit{\nano \meter}$}}};
		\node at (2.3,-0.4){\textcolor{trigon}{{\tiny $\num{456.659}\unit{\nano \meter}$}}};
