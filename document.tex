...
\begin{table}[htbp]  \centering  \caption{Add caption} \tiny   \begin{tabularx}{0.7\textwidth}{l|cr}    \multicolumn{1}{r}{} & \multicolumn{2}{l}{$E_\text{trans} (total)\approx1.44E_\text{trans}(\ce{NO}) $} \\    \multicolumn{1}{c|}{$E_\text{int.}(\ce{O})$} & \multicolumn{1}{l}{$= E_\text{total} -E_\text{bond}(\ce{O-NO})-E_\text{int.}(\ce{O})- E_\text{int.}(\ce{O}) $} &  \\    \midrule    \multirow{2}[1]{*}{$^3 P_2$} & $11081.35624\unit{\per \centi\meter}$ &  \\          & $10964.60854\unit{\per \centi\meter}$ &  \\    \multirow{2}[1]{*}{($\num{0}\unit{\per \centi \meter}$)} & $10794.14308\unit{\per \centi\meter}$ &  \\          & $9398.765977 \unit{\per \centi\meter}$&  \\    \midrule    \multirow{2}[1]{*}{$^3 P_1$} &$ 10922.73124 \unit{\per \centi\meter}$&  \\          & 10805.98354 &  \\    \multirow{2}[1]{*}{($\num{158.625}\unit{\per \centi \meter}$)} & 10635.51808 &  \\          & 9240.140977 &  \\    \midrule    \multirow{2}[1]{*}{$^3 P_0$} & 10854.37924 &  \\          & 10737.63154 &  \\    \multirow{2}[1]{*}{($\num{226.977}\unit{\per \centi \meter}$)} & 10567.16608 &  \\          & 9171.788977 &  \\    \bottomrule    \end{tabularx}%  
\end{table}%
\end{frame}
