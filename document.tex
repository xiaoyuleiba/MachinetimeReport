...
\begin{tikzpicture}
	...
	\node[anchor=west] at (-1.5,-1.8){$^3P_1 $};
	\node[anchor=west] at (-1.5,-2.3){{\footnotesize $ 12.54\unit{\meter \per \second}/\text{px}$}};
	\node[anchor=west] at (-1.5,-2.8){Intercept $\approx-1332$};
