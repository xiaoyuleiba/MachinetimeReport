...
\begin{frame}{\insertsubsection}\nocite{pgopher}
			...
			\begin{tabularx}{0.97\textwidth}{llll}    
				...
				\midrule 
				$rR2\:44.5$ & $rR2\:45.5$ &  &$sR21\left( 58.5\right) $\\  
				\textcolor{red}{$qR12\left( 51.5\right) $} & \textcolor{red}{$qR12 \left( 51.5\right) $} &  $sR21\left( 48.5\right) $ & \textcolor{red}{$pQ12 \:76.5$} \\ 
				\textcolor{red}{$qQ2\: 51.5$} & \textcolor{red}{$qQ2\: 51.5$} &   & \textcolor{red}{$pP2\: 76.5$} \\ 
				\bottomrule    
			\end{tabularx}%  
			\label{tab:addlabel}%
		\end{table}%
...
\begin{tikzpicture}
	...
	\node at (-4,-2){{\footnotesize $12.42\unit{\meter \per \second}/\text{px}\,@\, ^3P_2 $}};
	\node at (0,-2){{\footnotesize $ 12.54\unit{\meter \per \second}/\text{px}\,@\, ^3P_1$}};
	\node at (4,-2){{\footnotesize $ 12.50\unit{\meter \per \second}/\text{px}\,@\, ^3P_0$}};
\end{tikzpicture}
\end{figure}
\end{frame}
\begin{frame}{\insertsubsection}{\insertsubsubsection}
