...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.5]
		...
		\node[above] at (4.5,-5){{\tiny +10 peak}};
		\node[below] at (4.5,-5){{\tiny 48.5$\rightarrow$58.5}};
		\node[anchor=west,cyan] at (2,2.9){ Only 2 peaks};
		\node[anchor=west,cyan] at (2,2.2){which seem more valid.};
		\node[anchor=west,cyan] at (2,1.5){But all statistics tools};
		\node[anchor=west,cyan] at (2,0.8){cannot be properly applied if the amount of data $⩽3$.};
		}
	\end{tikzpicture}
	\begin{table}
		\centering  	 
